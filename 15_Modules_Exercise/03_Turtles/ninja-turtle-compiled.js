...
class NinjaTurtle extends Turtle {
    ...
    toString() {
        let title;
        if (this.level < 25) title = 'an apprentice';else if (this.level >= 25 && this.level < 100) title = 'smokin strong';else title = 'BEYOND GODLIKE';
...
//# sourceMappingURL=ninja-turtle-compiled.js.map